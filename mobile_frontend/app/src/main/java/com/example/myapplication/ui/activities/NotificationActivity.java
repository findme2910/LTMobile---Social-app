...
public class NotificationActivity extends AppCompatActivity {
    ...
    //xử lý sau
    private List<Notification> getListNoti (){
        List<Notification> list = new ArrayList<>();
        list.add(new Notification("Đã thích bài viết của bạn", R.drawable.avt_2, "Thái Sơn", new Date(2020 - 1900, 12, 14,6,30,30),false));
        list.add(new Notification("Đã chấp nhận lời mời kết bạn", R.drawable.avt_1, "Quang Huy", new Date(2003 - 1900, 12, 14,6,30,30),false));
        return list;
    }
